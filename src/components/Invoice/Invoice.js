...
const Invoice = ({
    ...
    const restName = restData[RestaurantDBFields.restaurantName];
    ...
    return (
        <View style={styles.Container}>
            ...
            <Text style={styles.FooterText} numberOfLines={2}>Contact : +91 {restData.contactNo} | {restData.email}</Text>
